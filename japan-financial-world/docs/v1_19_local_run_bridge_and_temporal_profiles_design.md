...
`InformationReleaseCalendar` layer (**shipped** —
...
book is empty by default). v1.19.4 lands the UI local bundle
loader (and an optional stub local server). v1.19.last
freezes.
