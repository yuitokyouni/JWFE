...
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| **v1.21 Institutional Investor Mandate / Benchmark Pressure** | benchmark / peer / mandate constraints on the v1.15.5 / v1.16.2 investor-intent layer; bounded synthetic mandate / benchmark id vocabulary. | Roadmap candidate.                                                                  |
| **v1.21 Multi-scenario monthly stress library**          | the v1.20.0 design's optional opt-in 4-scenario fixture (rate_repricing month 3 / credit_tightening month 4 / liquidity_stress month 6 / information_gap month 8) wired into a `scenario_multi_monthly_reference_universe` profile.                                                                                                            | Roadmap candidate.                                                                  |
