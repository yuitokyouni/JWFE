...
**Latest concrete code milestone: v1.20.5 UI universe / sector
/ monthly scenario rendering.** Fifth concrete code milestone
of the v1.20 sequence — extends the static workbench mockup
